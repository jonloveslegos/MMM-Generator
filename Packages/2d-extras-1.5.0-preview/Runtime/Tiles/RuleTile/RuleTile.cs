...
namespace UnityEngine
{
    ...
    public class RuleTile : TileBase
    {
        ...
        public BoolEnum m_DefaultCanFollow = BoolEnum.yes;
        /// <summary>
        ...
        public class TilingRuleOutput
        {
            ...
            public Sprite m_DefaultSprite;
            public BoolEnum m_canFollow = BoolEnum.yes;
            /// <summary>
        ...
        public virtual bool RuleMatch(int neighbor, TileBase other)
        {
            ...
            if (other is RuleTile)
            {
                switch (neighbor)
                {
                    case TilingRule.Neighbor.This: return other == this;
                    case TilingRule.Neighbor.NotThis: return other != this;
                    case TilingRule.Neighbor.Empty: return other != null && other != this && (other as RuleTile).m_DefaultCanFollow == BoolEnum.yes;
                }
            }
            else
            {
                switch (neighbor)
                {
                    case TilingRule.Neighbor.This: return other == this;
                    case TilingRule.Neighbor.NotThis: return other != this;
                    case TilingRule.Neighbor.Empty: return other != null && other != this;
                } 
            }
            return true;
        }
