...
namespace UnityEditor
{
    ...
    public class RuleTileEditor : Editor
    {
        ...
        public static Texture2D[] arrows
        {
            get
            {
                if (s_Arrows == null)
                {
                    ...
                    s_Arrows[10] = Base64ToTexture(s_Rotated);
                }
                return s_Arrows;
            }
        }
        ...
        public void OnAddElement(ReorderableList list)
        {
            ...
            rule.m_canFollow = tile.m_DefaultCanFollow;
        ...
        public override void OnInspectorGUI()
        {
            ...
            tile.m_DefaultCanFollow = (BoolEnum)EditorGUILayout.EnumPopup("Can Follow", tile.m_DefaultCanFollow);
        ...
        public virtual void SpriteOnGUI(Rect rect, RuleTile.TilingRuleOutput tilingRule)
        {
            ...
            tilingRule.m_DefaultSprite = tilingRule.m_Sprites[0];
        }

        public void RuleInspectorOnGUI(Rect rect, RuleTile.TilingRuleOutput tilingRule)
        {
            float y = rect.yMin;
            GUI.Label(new Rect(rect.xMin, y, k_LabelWidth, k_SingleLineHeight), "Default Sprite");
            tilingRule.m_DefaultSprite = EditorGUI.ObjectField(new Rect(rect.xMin + k_LabelWidth, y, rect.width - k_LabelWidth, k_SingleLineHeight), tilingRule.m_DefaultSprite, typeof(Sprite), false) as Sprite;
